...
def jacobian_dot(physical_parameters: Dict, q: NDArray, q_dot: NDArray
    ...
    J_dot_11 = ((np.cos(arg_num_1) * arg_num_1_dot * np.sin(arg_num_2)
                 + np.sin(arg_num_1) * np.cos(arg_num_2) * arg_num_2_dot) * np.sin(arg_den)
                - np.sin(arg_num_1) * np.sin(arg_num_2) * np.cos(arg_den) * arg_den_dot) / np.sin(arg_den) ** 2
    J_dot_21 = ((np.sin(arg_num_1) * arg_num_1_dot * np.sin(arg_num_2)
                 - np.cos(arg_num_1) * np.cos(arg_num_2) * arg_num_2_dot) * np.sin(arg_den)
                + np.cos(arg_num_1) * np.sin(arg_num_2) * np.cos(arg_den) * arg_den_dot) / np.sin(arg_den) ** 2
    ...
    J_dot_14 = - ((np.cos(arg_num_1) * arg_num_1_dot * np.sin(arg_num_2)
                   + np.sin(arg_num_1) * np.cos(arg_num_2) * arg_num_2_dot) * np.sin(arg_den)
                  - np.sin(arg_num_1) * np.sin(arg_num_2) * np.cos(arg_den) * arg_den_dot) / np.sin(arg_den) ** 2
    J_dot_24 = - ((np.sin(arg_num_1) * arg_num_1_dot * np.sin(arg_num_2)
                   - np.cos(arg_num_1) * np.cos(arg_num_2) * arg_num_2_dot) * np.sin(arg_den)
                  + np.cos(arg_num_1) * np.sin(arg_num_2) * np.cos(arg_den) * arg_den_dot) / np.sin(arg_den) ** 2
...
def _jacobian_beta_dot_ii(arg_num, arg_den, arg_num_dot, arg_den_dot):
    J_dot_ii = (-np.cos(arg_num) * arg_num_dot * np.sin(arg_den)
